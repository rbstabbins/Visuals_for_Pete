...
//
// MIDI Controls 3 band EQ, with Korg Sliders, and sensitivity with dials
// Needs some investigation into best way to tune mappings
//
// Roger Stabbins
// 27/01/2020
...
int side; // side length of this square
